...
public class RestClient implements ClientHttpRequestInterceptor {
    ...
    public Device createDevice(String name, String typeId) {
        Device device = new Device();
        device.setName(name);

        device.setTypeId(new TypeId(UUIDConverter.fromString(typeId)));
    ...
    public Asset createAsset(String name, String typeId) {
        Asset asset = new Asset();
        asset.setName(name);
        asset.setTypeId(new TypeId(UUIDConverter.fromString(typeId)));
        return restTemplate.postForEntity(baseURL + "/api/asset", asset, Asset.class).getBody();
    }
