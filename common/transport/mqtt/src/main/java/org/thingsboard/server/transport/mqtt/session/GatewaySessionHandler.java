...
public class GatewaySessionHandler {
    ...
    public void onDeviceConnect(MqttPublishMessage msg) throws AdaptorException {
        ...
        String deviceType = getDeviceTypeId(json);
    ...
    private ListenableFuture<GatewayDeviceSessionCtx> onDeviceConnect(String deviceName, String deviceTypeId) {
    ...
    private ListenableFuture<GatewayDeviceSessionCtx> checkDeviceConnected(String deviceName) {
        ...
        if (ctx == null) {
            ...
            return onDeviceConnect(deviceName, "0");
        } else {
    ...
    private String getDeviceTypeId(JsonElement json) throws AdaptorException {
        JsonElement type = json.getAsJsonObject().get("typeId");
