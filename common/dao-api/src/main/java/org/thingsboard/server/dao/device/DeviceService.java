...
public interface DeviceService {
    ...
    TextPageData<DeviceInfo> findAllDevices(TenantId tenantId, TextPageLink pageLink);
    //    long findAllDevicesCount(TenantId tenantId);
    TextPageData<DeviceInfo> findAllDevices(TenantId tenantId, UUID typeId , UUID assetId, TextPageLink pageLink);
...
//
//    ListenableFuture<List<EntitySubtype>> findTenantDeviceTypes(TenantId tenantId);
}
