...
public interface DeviceDao extends Dao<Device> {
     ...
     * @return the list of device objects
     */
    List<DeviceInfo> findAllDevices(UUID tenantId, TextPageLink pageLink);
    long findAllDevicesCount(UUID tenantId);
    List<DeviceInfo> findAllDevices(UUID tenantId, UUID typeId, UUID assetId, TextPageLink pageLink);
    long findAllDevicesCount(UUID tenantId, UUID typeId, UUID assetId);
    /**
...
//     * @return the list of tenant device type objects
//     */
//    ListenableFuture<List<EntitySubtype>> findAllTenantDeviceTypesAsync(UUID tenantId);
}
