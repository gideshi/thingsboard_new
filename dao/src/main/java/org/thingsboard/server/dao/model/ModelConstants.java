...
public class ModelConstants {
     ...
     * Cassandra tenant constants.
     */
    public static final String TYPE_COLUMN_FAMILY_NAME = "type_spec";
    public static final String TYPE_PID_PROPERTY = "pid";
    public static final String TYPE_NAME_PROPERTY = "type_name";
    public static final String TYPE_TYPE_PROPERTY = "type";
//
//    public static final String TENANT_BY_REGION_AND_SEARCH_TEXT_COLUMN_FAMILY_NAME = "tenant_by_region_and_search_text";
...
//    public static final String DEVICE_TYPE_PROPERTY = "type";
    public static final String DEVICE_SPEC_PROPERTY = "spec";
    public static final String DEVICE_TYPE_PROPERTY = "type_id";
    ...
    public static final String ASSET_TYPE_PROPERTY = "type_id";
