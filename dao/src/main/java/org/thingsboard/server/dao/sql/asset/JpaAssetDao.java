...
public class JpaAssetDao extends JpaAbstractSearchTextDao<AssetEntity, Asset> implements AssetDao {
    ...
    @Override
    public List<Asset> findEquipByTenantId(UUID tenantId) {
        return DaoUtil.convertDataList(assetRepository.findEquipByTenantId(fromTimeUUID(tenantId)));
//                        ,Objects.toString(pageLink.getTextSearch(), ""),
//                        pageLink.getIdOffset() == null ? NULL_UUID_STR : fromTimeUUID(pageLink.getIdOffset()),
//                PageRequest.of(0, pageLink.getLimit())
    ...
    private List<EntitySubtype> convertTenantAssetTypesToDto(UUID tenantId, List<TypeId> types) {
