...
//            Assert.assertEquals("typeA", deviceTypes.get(0).getTypeId());
//            Assert.assertEquals("typeB", deviceTypes.get(1).getTypeId());
//            Assert.assertEquals("typeC", deviceTypes.get(2).getTypeId());
        } finally {
