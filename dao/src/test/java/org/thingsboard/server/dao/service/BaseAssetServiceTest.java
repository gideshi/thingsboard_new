...
//                asset.setTypeId("typeA");
            ...
            Assert.assertEquals("typeA", assetTypes.get(0).getTypeId());
            Assert.assertEquals("typeB", assetTypes.get(1).getTypeId());
            Assert.assertEquals("typeC", assetTypes.get(2).getTypeId());
        } finally {
