...
public class DefaultActorService implements ActorService {
    ...
    @Override
    public void onDeviceNameOrTypeUpdate(TenantId tenantId, DeviceId deviceId, String deviceName, TypeId deviceTypeId) {
        log.trace("[{}] Processing onDeviceNameOrTypeUpdate event, deviceName: {}, deviceType: {}", deviceId, deviceName, deviceTypeId);
        DeviceNameOrTypeUpdateMsg msg = new DeviceNameOrTypeUpdateMsg(tenantId, deviceId, deviceName, deviceTypeId);
        appActor.tell(new SendToClusterMsg(deviceId, msg), ActorRef.noSender());
    }
