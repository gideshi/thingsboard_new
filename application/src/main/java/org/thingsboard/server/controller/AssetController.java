...
public class AssetController extends BaseController {
    ...
    @PreAuthorize("hasAuthority('TENANT_ADMIN')")
    @RequestMapping(value = "/tenant/equips", method = RequestMethod.GET)
    @ResponseBody
    public List<Asset> getTenantAssets() throws ThingsboardException {
        try {
            TenantId tenantId = getCurrentUser().getTenantId();

                return checkNotNull(assetService.findEquipByTenantId(tenantId));
        } catch (Exception e) {
            throw handleException(e);
        }
    }
